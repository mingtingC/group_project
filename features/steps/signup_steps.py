...
@then(u'she should see a message of This username is already used.')
def see_register_failure1(context):
    time.sleep(0.4)
    flaskr_found = re.search("This username is already used.", context.browser.page_source, re.IGNORECASE)
    assert flaskr_found


@then(u'she turns to home page')
